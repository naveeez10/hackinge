...
mixin _$LoginState {
  ...
  dynamic get otpError => throw _privateConstructorUsedError;
  ...
  $Res call({
    ...
    return _then(_$_LoginState(
      ...
      isSubmittingOtp: null == isSubmittingOtp
          ...
          : isSubmittingOtp // ignore: cast_nullable_to_non_nullable
              as bool,
      otpError: freezed == otpError ? _value.otpError! : otpError,
    ));
  }
}
...
abstract class _LoginState implements LoginState {
  const factory _LoginState(
      ...
      required final dynamic otpError}) = _$_LoginState;
